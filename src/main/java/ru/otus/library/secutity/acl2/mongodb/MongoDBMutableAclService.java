 ...
 */
package ru.otus.library.secutity.acl2.mongodb;
...
import ru.otus.library.secutity.acl2.domain.DomainObjectPermission;
import ru.otus.library.secutity.acl2.domain.MongoAcl;
import ru.otus.library.secutity.acl2.domain.MongoSid;
...
public class MongoDBMutableAclService extends MongoDBAclService implements MutableAclService {
    ...
    public Map<ObjectIdentity, Acl> readAclsById(List<ObjectIdentity> objects, List<Sid> sids)
        ...
        // Create Acl if unknown
        for (ObjectIdentity oid : objects) {
            if (!result.containsKey(oid)) {
                result.put(oid,createDenyAcl(oid,sids));
            }
        }
