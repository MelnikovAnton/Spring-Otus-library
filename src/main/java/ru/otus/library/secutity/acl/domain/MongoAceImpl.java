...
public class MongoAceImpl implements AccessControlEntry, AuditableAccessControlEntry {
    ...
    public MongoAceImpl(Serializable id, Acl acl, Sid sid,
    ...
    public boolean equals(Object arg0) {
        if (!(arg0 instanceof MongoAceImpl)) {
            return false;
        }

        MongoAceImpl rhs = (MongoAceImpl) arg0;
